...
const pokeTipes = [tipoAgua , tipoElectricidad, tipoFuego, tipoNormal, tipoPlanta]

let pokeCard = ""
for (let pokemonTipo of pokeTipes){
    pokeCard +=`
...
const pokeContainer = document.querySelector("section")
